...
export const translations: Record<LanguageCode, Translations> = {
  ...
  ar: { // Directionality (RTL) should be handled in CSS/layout if needed
    ...
    vehicles: {
      ...
      driver: {
        title: 'تعرف على سائقك المحترف: عبدالله الجول', // Updated title
        bio: 'عبدالله الجول هو حجر الزاوية في التزام الجول ترانسفير بالتميز. يتم اختياره بدقة، ويتم فحصه أمنيًا، ويمتلك سنوات من الخبرة في التنقل في أنطاليا والمناطق المحيطة بها. ملتزم بتقديم خدمة آمنة ودقيقة وفي الوقت المحدد، مما يضمن أن تكون رحلتك سلسة وممتعة. تتوفر إمكانات متعددة اللغات عند الطلب لتلبية احتياجات الاتصال الخاصة بك.', // Updated bio
        alt: 'صورة شخصية احترافية لعبدالله الجول',
      securityVetted: 'تم فحصه أمنيًا',
     ...
     pricing: {
      ...
      tableHeadings: {
        ...
        requestQuote: 'اطلب عرض أسعار مخصص', // Remove extra 's' at the begining
        requestQuoteMessage: 'مرحباً الجول ترانسفير، أود طلب عرض أسعار مخصص لنقل VIP.', // Message for quote button
    }, 
    video: {
        title: 'جرب فرق الجول',
    },
    contact: { 
        ...
        whatsappMessage: 'مرحباً الجول ترانسفير، أود الاستفسار عن خدماتكم.', 
    }, 
     footer: {
        logoAlt: 'شعار الجول للنقل VIP', 
